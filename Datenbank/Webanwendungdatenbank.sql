...
--
-- Table structure for table `admin/verwalter`
--

DROP TABLE IF EXISTS `admin/verwalter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `admin/verwalter` (
  `ID` int NOT NULL,
...
--
-- Dumping data for table `admin/verwalter`
--

LOCK TABLES `admin/verwalter` WRITE;
/*!40000 ALTER TABLE `admin/verwalter` DISABLE KEYS */;
/*!40000 ALTER TABLE `admin/verwalter` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `dognle`
--

DROP TABLE IF EXISTS `dognle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dognle` (
  `Lfd. Nr.` int NOT NULL,
  ...
  `Name` varchar(45) NOT NULL,
  `Gültig von` datetime NOT NULL,
  `Gültig bis` datetime NOT NULL,
  `Projekt/Produkt` varchar(45) NOT NULL,
  `Standort` varchar(45) NOT NULL,
  `Händler` varchar(45) NOT NULL,
  `Datum letzte Änderung` datetime NOT NULL,
  `Datum Erstausgabe` datetime NOT NULL,
  `Benutzer_Firmcode` int NOT NULL,
  PRIMARY KEY (`Lfd. Nr.`,`Benutzer_Firmcode`),
  KEY `fk_Dognle_Benutzer1_idx` (`Benutzer_Firmcode`),
  CONSTRAINT `fk_Dognle_Benutzer1` FOREIGN KEY (`Benutzer_Firmcode`) REFERENCES `benutzer` (`Firmcode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dognle`
--

LOCK TABLES `dognle` WRITE;
/*!40000 ALTER TABLE `dognle` DISABLE KEYS */;
/*!40000 ALTER TABLE `dognle` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `lizenz` (
  ...
  CONSTRAINT `fk_Lizenz_Dognle` FOREIGN KEY (`Dognle_Lfd. Nr.`) REFERENCES `dognle` (`Lfd. Nr.`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket` (
  ...
  CONSTRAINT `fk_Ticket_Admin/Verwalter1` FOREIGN KEY (`Admin/Verwalter_ID`) REFERENCES `admin/verwalter` (`ID`),
  CONSTRAINT `fk_Ticket_Benutzer1` FOREIGN KEY (`Benutzer_Firmcode`) REFERENCES `benutzer` (`Firmcode`),
  CONSTRAINT `fk_Ticket_Dognle1` FOREIGN KEY (`Dognle_Lfd. Nr.`, `Dognle_Benutzer_Firmcode`) REFERENCES `dognle` (`Lfd. Nr.`, `Benutzer_Firmcode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-14 13:28:38
